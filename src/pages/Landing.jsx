...
export default function Landing() {
  ...
  return (
    <div className={`min-h-screen font-sans selection:bg-blue-500/30 transition-colors duration-700 ${isDarkMode ? 'bg-zinc-950 text-white' : 'bg-[#FFFDF9] text-slate-900'}`}>
      
      {/* 1. NAVIGATION */}
      <nav className="max-w-7xl mx-auto px-6 py-6 flex justify-between items-center">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-full bg-blue-600 text-white flex items-center justify-center font-bold text-sm shadow-lg shadow-blue-600/20">
            KS
          </div>
          <span className="font-extrabold text-xl tracking-tight">KoboSats</span>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-6 pt-12 pb-24 md:pt-20 md:pb-32 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="space-y-8 relative z-10">
          <div className={`inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-bold border ${isDarkMode ? 'bg-blue-900/20 border-blue-900/50 text-blue-400' : 'bg-blue-50 border-blue-100 text-blue-600'}`}>
          ...
          <p className={`text-lg md:text-xl font-medium leading-relaxed max-w-lg ${isDarkMode ? 'text-slate-400' : 'text-slate-600'}`}>
          ...
          <div className={`flex items-center gap-6 pt-4 text-xs font-semibold ${isDarkMode ? 'text-slate-500' : 'text-slate-400'}`}>
        ...
        <div className="relative flex justify-center lg:justify-end">
          ...
          <div className={`w-full max-w-md p-8 rounded-[2rem] border-4 shadow-2xl relative z-10 animate-[bounce_6s_ease-in-out_infinite] ${isDarkMode ? 'bg-zinc-900 border-zinc-800 shadow-black/50' : 'bg-white border-white shadow-slate-200/50'}`}>
            <div className="flex justify-between items-center mb-8">
              ...
              <div className="w-6 h-6 rounded-full bg-blue-600 text-white flex items-center justify-center text-[10px] font-bold">KS</div>
            </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-24 border-t border-slate-200/50 dark:border-zinc-800/50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            <div key={i} className={`p-8 rounded-[2rem] border transition-all duration-300 hover:-translate-y-1 hover:shadow-xl ${isDarkMode ? 'bg-zinc-900 border-zinc-800 hover:border-blue-900/50' : 'bg-white border-slate-200 hover:border-blue-100 hover:shadow-blue-900/5'}`}>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-24">
        <div className="w-full rounded-[3rem] p-10 md:p-16 flex flex-col md:flex-row items-center justify-between gap-10 bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 text-white shadow-2xl shadow-blue-900/20 relative overflow-hidden">
      ...
      <footer className={`max-w-7xl mx-auto px-6 py-8 flex flex-col sm:flex-row justify-between items-center gap-4 border-t ${isDarkMode ? 'border-zinc-800/50 text-slate-500' : 'border-slate-200 text-slate-400'}`}>
        <div className="flex items-center gap-2">
          <div className="w-5 h-5 rounded-full bg-blue-600 text-white flex items-center justify-center font-bold text-[8px]">
            KS
          </div>
